    ...
    return (
        <div className={clsx(styles.slide, className)}>
            <div className={styles.slide__info}>
                ...
                <Button className={styles.slide__more} color="purple" href={href} target="_blank">
                    {t('view')}
                </Button>
            </div>
            <div className={styles.slide__imgWrapper}>
                <Image className={styles.slide__img} priority={priority} layout="fill" src={src} alt={title} />
            </div>
        </div>
    )
}
