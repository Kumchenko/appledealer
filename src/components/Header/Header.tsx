...
const Header = ({ navPoints, socialPoints }: IHeaderProps) => {
    ...
    const socialElems = useMemo(
        () =>
            socialPoints.map(({ href, child }) => (
        ...
        <header className={styles.header}>
            <div className={styles.info}>
                <div className={clsx(styles.container, 'container')}>
                    ...
                    <Button onClick={handleCallClick} className={styles.info__call} color="green">
                        {t('call-me')}
                    </Button>
                </div>
            </div>
                ...
                <div className={clsx(styles.container, 'container')}>
                    ...
                    <ul className={styles.menu__list}>
                        ...
                        <div className={styles.menu__other}>
                            <ul className={styles.social__list}>{socialElems}</ul>
                            <ul className={styles.lang__list}>{langElems}</ul>
                        </div>
                    </ul>
