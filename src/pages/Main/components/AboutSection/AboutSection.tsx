    ...
    return (
        <section id="about" className={styles.about}>
            <div className={clsx(styles.container, styles.grid, 'container grid')}>
                <h1 className={styles.about__title}>{i('h1')}</h1>
                <p className={styles.about__subtitle}>{i('subtitle')}</p>
                <address className={styles.info}>
                    ...
                    <a
                        className={styles.info__address}
                        href="https://goo.gl/maps/XLexykR1npzgqB2R7"
                        target="_blank"
                    ...
                    <div className={styles.info__contacts}>
                        <Button className={styles.info__call} color="purple" href="tel:+380635005050" target="_self">
                            +380635005050
                        </Button>
                        <Button onClick={handleCallClick} className={styles.info__callme} color="green">
                            {t('call-back')}
                        </Button>
                    </div>
                </address>
                <div className={styles.about__mapWrapper}>
                    ...
                    <iframe
                        ...
                        src={`https://www.google.com/maps/embed/v1/place?key=${env.mapKey}
