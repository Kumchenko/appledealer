            ...
            <div className={clsx(styles.container, "container")}>
                ...
                >
                    <Form className={clsx(styles.form, "form grid")}>
                        <Tile title="Модель" className={styles.form__tile}>
                        ...
                        <Tile title="Контактні дані" className={styles.form__tile}>
                            <label className={clsx(styles.form__label, 'form__label')}>
                                Імʼя
                                <ErrorMessage className="form__error" name="name" component="span" />
                                <Field className="form__input" name="name" id="name" type="text" placeholder="Ваше імʼя" required />
                            </label>
                            <label className={clsx(styles.form__label, 'form__label')}>
                                Прізвище
                                <ErrorMessage className="form__error" name="surname" component="span" />
                                <Field className="form__input" name="surname" id="surname" type="text" placeholder="Ваше прізвище" required />
                            </label>
                            <label className={clsx(styles.form__label, 'form__label')}>
                                Телефон
                                <ErrorMessage className="form__error" name="tel" component="span" />
                                <Field className="form__input" name="tel" id="tel" type="tel" pattern="[+]{1}38[0]{1}[0-9]{9}" placeholder="+38(___)-___-__-__" required />
                            </label>
                            <label className={clsx(styles.form__label, 'form__label')}>
                                Email
                                <ErrorMessage className="form__error" name="email" component="span" />
                                <Field className="form__input" name="email" id="email" type="email" placeholder="example@example.com" required />
                            </label>
                        </Tile>
                        <Tile title="Замовлення" className={styles.form__tile}>
                            <label className={clsx(styles.form__label, 'form__label')}>
                                Компонент
